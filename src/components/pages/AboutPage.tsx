...
export function AboutPage({ locale }: { locale: Locale }) {
  ...
  return (
    <Column fillWidth style={{ maxWidth: "1400px" }}>
      ...
      <Row fillWidth m={{ direction: "column" }} s={{ direction: "column" }} horizontal="center">
        {about.avatar.display && (
          <Column
            ...
            fitHeight
            position="sticky"
            m={{ position: "relative", style: { top: "auto" } }}
            s={{ position: "relative", style: { top: "auto" } }}
            xs={{ style: { top: "auto" } }}
            minWidth="0"
            style={{ minWidth: "min(160px, 100%)", maxWidth: "100%" }}
            paddingX="l"
            paddingBottom="xl"
            gap="m"
            flex={3}
          ...
          >
            {about.calendar.display && (
              ...
              >
                ...
                <Row paddingX="8">{locale === "vi" ? "Dat lich trao doi" : "Schedule a call"}</Row>
                <IconButton
